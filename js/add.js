...
function sumbit() {
    ...
    var lesson = document.getElementById('lesson1').value;
    ...
    iTd8.className = "col8";
    iTd8.appendChild(document.createTextNode(lesson));
    var iTd9 = document.createElement('td');
    iTd9.className = "col9";
    iTd9.appendChild(document.createTextNode(teacher));
    ...
    document.getElementById('lesson1').value = null;
    document.getElementById('teacher1').value = null;
