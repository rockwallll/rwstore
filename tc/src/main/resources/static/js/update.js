...
function update(obj) {
    ...
    document.getElementById('lesson2').value = iTds[7].innerText;
    document.getElementById('teacher2').value = iTds[8].innerText;
}
...
function preservation() {
    ...
    iTds[7].innerText = document.getElementById('lesson2').value;
    iTds[8].innerText = document.getElementById('teacher2').value;
    // 关闭修改框架
